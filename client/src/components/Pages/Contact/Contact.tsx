...
import { contactStyle } from "../../../assets";
            ...
            <div className="card card0 border-0">
                <div className="row">
                    <div className="col-md-6 col-lg-6 col-xl-6 col-sm-12">
                        <div className={contactStyle.card1}>
                    ...
                    <div className="col-md-6 col-lg-6 col-xl-6 col-sm-12">
                        <div className="row mt-3 text-center">
                            ...
                            <div className={contactStyle.lineDiv}>
                                <div className={contactStyle.line} />
                                <small className={contactStyle.or}>OR</small>
                                <div className={contactStyle.line} />
                            </div>
                            <div className={`mt-3 ${contactStyle.contactForm}`}>
                                <div className="px-3">
                                    <input
                                        type="text"
                                        name="name"
                                ...
                                <div className="px-3 text-center">
                                    <button
                                        type="submit"
                                        className={`btn btn-primary mb-3 ${contactStyle.button}`}
